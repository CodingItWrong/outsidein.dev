...
Node's "LTS" (long-term support) version is recommended for most users. As of the time of writing, the LTS version is 16.15.0 -- you can run `node -v` to check your version.
